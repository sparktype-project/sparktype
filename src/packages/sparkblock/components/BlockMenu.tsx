...
export function BlockMenu({ show, availableBlocks, onSelectBlock, onClose }: BlockMenuProps) {
  ...
  return (
    <div 
      className="fixed bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg min-w-[250px] max-h-[300px] overflow-auto z-[1000] md:max-w-[90vw]" 
