					...
					<PopoverContent
						...
						<Command shouldFilter={false}>
							...
							<CommandList className="max-h-[50vh] overflow-y-auto">
								...
								{!hideSelectAll && getAllOptions().length > 0 && (
									<>
										<CommandGroup>
											<CommandItem
												key="all"
												...
												return (
													<CommandItem
														...
														className={cn(
															...
															animationConfig?.optionHoverAnimation === "highlight" &&
																"hover:bg-primary/10",
															animationConfig?.optionHoverAnimation === "scale" &&
																"hover:scale-[1.02] transition-transform",
															animationConfig?.optionHoverAnimation === "glow" &&
